...
7. `docs/API_연차.md` — 연차 잔여 · 대장 · 달력 · 발생 엔드포인트
...
- [ ] **2026년 공휴일 입력** — 등록된 것이 양력 고정일 9건뿐이다. 설날·추석·부처님오신날·대체공휴일이
      전부 빠져 있어 지금 상태로는 설 연휴가 연차에서 깎인다 (`docs/API_연차.md` 8장)
- [ ] 전자서명 구현 방식 확정 → S-302 와 **A-302 결재**가 걸려 있다 (`docs/API_신청결재.md` 7장 1번)
...
- API 명세(보험 요율·신청결재·연차) (2026-08-27)
