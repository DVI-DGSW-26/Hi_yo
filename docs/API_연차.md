...
**연차 차감일 계산에서 이 날짜들이 빠진다.** A-103 계열이 쓸 화면이 아직 없다.

| 메서드 | 경로 | 권한 | 용도 |
|---|---|---|---|
| GET | `/holidays` | — | 목록. `year` 선택 |
...
TODO: `holidayType`에 어떤 값이 들어가는지가 스펙에 없다. 확인일 기준 전부 `PUBLIC`이다.
회사 지정 휴무일에 무엇을 넣어야 하는지 모른다.

### 공휴일은 지금 빠져 있다 (2026-08-27 확인, 2026-08-28 재확인 — 그대로다)
