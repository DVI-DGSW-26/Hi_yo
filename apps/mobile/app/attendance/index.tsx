 ...
 *
 * **52시간을 막대로 그리지 않는다. 서버가 비율을 주지 않기 때문이다.** 앱에서 52시간을
 * 나눠 만들면 산정 기준을 앱이 정하는 것이 된다 — 그건 추측 금지 항목이다.
 * 관리팀 A-503과 같이 분과 단계 문구로 둔다. 비율 막대 컴포넌트(`Gauge`)가 이 자리를
 * 기다리며 남아 있었는데, 쓸 일이 없어 지웠다 (2026-09-03).
 *
